...
<body>
	<div id="wrap">
		...
		<div class="page_content">
			...
			<%
			String location = "C:\\Web2\\WS\\Project\\WebContents\\downloadImage";
            ...
            <div class="joinComplete">
               ...
               <p class="desc">파일이 업로드 되었습니다.!!</p>
               <p class="desc">상품명 = <%=name%></p>
               <p class="desc">종류 = <%=memo%></p>
               <p class="desc">가격 = <%=price%></p>
               <p class="desc">이미지 = <%=image%></p>
            </div>
